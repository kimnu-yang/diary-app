...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    // select * from user where kakao_user_id = ? and status = ? order by id desc limit 1
    Optional<UserEntity> findFirstByKakaoUserIdAndStatusOrderByIdDesc(Long kakaoUserId, UserStatus status);
